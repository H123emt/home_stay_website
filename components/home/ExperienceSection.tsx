                ...
                >
                  ...
                  <div className="flex flex-col gap-3 p-6 flex-1">
                    <div>
                      ...
                      <p className="mt-1 text-xs font-dark text-[#112211] italic">
                        {exp.subtitle}
                      </p>
                    </div>
                    <p className="text-sm font-dark text-[#112211] leading-relaxed line-clamp-2 flex-1">
                      {exp.description}
                    </p>

                    <div className="flex items-center gap-4 pt-2 border-t border-[#112211]/60">
                      <div className="flex items-center gap-1.5">
                        <Clock className="w-3 h-3 text-[#112211]" />
                        <span className="text-[10px] font-dark uppercase tracking-wider text-[#112211]/90">
                          {exp.duration}
                        </span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <Users className="w-3 h-3 text-[#112211]" />
                        <span className="text-[10px] font-dark uppercase tracking-wider text-[#112211]/90">
                          {exp.groupSize}
                        </span>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <span className="text-xs font-dark text-[#112211]"> / person</span>
                      </div>
                      <Badge                      
                        variant={
                          exp.difficulty === "easy"
        ...
        <ScrollReveal direction="up" delay={0.4} blur>
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={stat.label}
                className="flex flex-col items-center gap-2 py-8 border border-[#112211]/8 text-center shadow-md shadow-black/10"
              >
                <p className="font-serif text-3xl sm:text-4xl font-dark text-[#112211]">
                  {stat.number}
                </p>
                <p className="text-[10px] font-dark uppercase tracking-[0.25em] text-[#112211]">
                  {stat.label}
                </p>
              </div>
            ))}
